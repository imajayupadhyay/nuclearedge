                ...
                <div class="absolute bottom-0 left-0 right-0 p-6 border-t border-white/10 bg-slate-950/50">
                    <div class="flex items-center gap-3">
                        ...
                        <a
                            ...
                            class="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-400 hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 hover:text-white transition-all"
                            :title="link.name"
                        >
