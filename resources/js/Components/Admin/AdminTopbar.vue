<template>
    <header class="bg-white shadow-sm border-b border-slate-200 fixed top-0 right-0 left-0 z-50">
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <!-- Left side - Logo & Title -->
                <div class="flex items-center space-x-4 ml-64">
                    <button
                        @click="toggleSidebar"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Manage your website</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:block relative">
                        <input
                            type="text"
                            placeholder="Search..."
                            class="w-64 pl-10 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                    ...
                    <div class="relative">
                        <button
                            ...
                            class="flex items-center space-x-3 px-3 py-2 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors"
                        >
...
const toggleSidebar = () => {
    // Emit event to toggle sidebar on mobile
