    ...
    <AdminLayout :user="$page.props.auth.user">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-600 mb-1">Projects</p>
                        <p class="text-2xl font-bold text-slate-900">0</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-600 mb-1">Messages</p>
                        <p class="text-2xl font-bold text-slate-900">0</p>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button class="p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg hover:shadow-md transition-all text-left group">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900">Add New Post</p>
                            <p class="text-sm text-slate-600">Create blog content</p>
                        </div>
                    </div>
                </button>

                <button class="p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg hover:shadow-md transition-all text-left group">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900">Manage Settings</p>
                            <p class="text-sm text-slate-600">Configure site options</p>
                        </div>
                    </div>
                </button>

                <button class="p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg hover:shadow-md transition-all text-left group">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900">View Analytics</p>
                            <p class="text-sm text-slate-600">Check site stats</p>
                        </div>
                    </div>
                </button>
            </div>
