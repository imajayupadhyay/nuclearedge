                    ...
                    <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div class="flex">
                            ...
                            <div class="text-sm text-blue-800">
                                <p class="font-medium mb-1">Category Information</p>
                                <ul class="list-disc list-inside space-y-1 text-xs">
                                    <li>Category ID: {{ category.id }}</li>
                                    <li>Created: {{ formatDate(category.created_at) }}</li>
                                    <li>Last Updated: {{ formatDate(category.updated_at) }}</li>
                                    <li v-if="category.parent">Parent: {{ category.parent.name }}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
